...
const ProfilePage = () => {
	...
	// };
	  ...
	  const {mutate:updatedUser,isError,isPending:isUpdatingProfile} = useMutation({
		mutationFn:async()=>{
			try {
      ...
      const isMyProfile =  authUser.existsUser._id===user?._id;
	  const{ follow, isPending} = useFollow();
	  const amIFollowing = authUser.existsUser?.following.includes(user?._id);
	  useEffect(()=>{
          refetch();
	  },[username,refetch])
